 ...
 * the CoAP, blockwise(分块的) CoAP, observing CoAP and supports arbitrary(任意的) defined
 * options.
 * <p>
 ...
 * {@link Option} to inspect(检查) its {@code value} is meaningless. Either use {@link Option}
